                            ...
                            itemBuilder: (context, index) => Dismissible(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) =>  itemDetails(cardcontroller.cardlist[index].name,
                                        cardcontroller.cardlist[index].price,cardcontroller.cardlist[index].description,cardcontroller.cardlist[index].pic,
                                      ),)
                                  );

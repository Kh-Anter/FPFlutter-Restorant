...
class _HomeScreenState extends State<HomeScreen> {
                          ...
                          children: <Widget>[
                            ...
                            DefaultTabController(
                                ...
                                child: Column(children: <Widget>[
                                  ...
                                  Container(
                                      height: _size
                                          .getProportionateScreenHeight(420),
                                      color: myBackgroundColor,
                                      child: TabBarView(children: <Widget>[
                                        category("food", _size,favcontroller),
                                        category("drink", _size,favcontroller),
                                        category("snacks", _size,favcontroller),
                                        category("sandwich", _size,favcontroller),
                                      ]))
                                ])),
                          ]),
                    ),
  ...
  Widget category(catName, size,fav) {
